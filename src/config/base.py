...
def get_config():
    ...
    # RL algorithm to use for the policy update.
    # Supported: "ppo" (default), "trpo", "sac", "policy_gradient"
    train.algorithm = "ppo"
    ...
    # TRPO trust region (approx) settings.
    train.trpo_max_kl = 1e-3
    train.trpo_init_beta = 1.0

    # Policy gradient settings.
    train.pg_entropy_coef = 0.0

    # SAC settings (optional; requires critic optimizer).
    train.sac_alpha = 0.2
    train.sac_gamma = 0.99
